...
const TRAITS: Trait[] = [
  ...
  },
  {
    ...
    requirement: "≥50 followers + ratio 1.2-2.0",
    eligible: true,
  },
  {
    id: "display",
    ...
    requirement: "≥500 followers + ratio 2.0-4.0",
    eligible: true,
  },
  {
    id: "orb",
    ...
    requirement: "≥1000 followers + ratio ≥ 4.0",
    eligible: true,
  },
  {
    id: "bronze-hands",
  ...
  },
  {
    ...
    tier: "Flags Tier 2",
    requirement: "Score ≥ 0.8 + power badge",
    eligible: true,
  },
  {
    id: "laser-eyes",
    name: "Laser Eyes",
    tier: "Flags Tier 1",
    requirement: "Score ≥ 0.9 + pro badge",
    eligible: true,
  },
];
